...
local function startWebhookTracking()
    task.spawn(function()
        local lastEndFrameState = false  -- ✅ TRACKEAR ESTADO ANTERIOR
        ...
        while task.wait(0.5) do
            if getgenv().WebhookConfig.Enabled then
                    ...
                    if gui then
                        ...
                        if endFrame then
                            ...
                            if currentState == true and lastEndFrameState == false and not getgenv().WebhookConfig.IsTracking then
                                ...
                                task.wait(1.5)  -- Esperar a que se muestren todos los datos
                ...
                lastEndFrameState = false  -- Reset si se desactiva
            end
        end
    end)
end
