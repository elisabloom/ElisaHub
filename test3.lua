...
local function getRandomPositionPath1()
    local startPos = Vector3.new(52.92366409301758, -21.75, -56.00194549560547)
    local endPos = Vector3.new(49.78079605102539, -21.75, -52.85907745361328)
    local t = math.random()
...
local function getRandomPositionPath2()
    local startPos = Vector3.new(-57.421451568603516, -21.75, -56.23777389526367)
    local endPos = Vector3.new(-53.74859619140625, -21.75, -52.56492614746094)
    local t = math.random()
    local randomX = startPos.X + t * (endPos.X - startPos.X)
    local randomZ = startPos.Z + t * (endPos.Z - startPos.Z)
    local position = Vector3.new(randomX, -21.75, randomZ)
