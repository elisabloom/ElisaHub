...
local function runVolcano()
    ...
    -- Función genérica de plantar con retry + tracking
        ...
        for attempt = 1, 50 do
            ...
            if success and result then
                ...
                if #myUnitIDs >= expectedCount then
                    ...
                    warn("[VOLCANO] ⚠️ Planted but not tracked (" .. unitDisplayName .. ") - retrying...")
                end
            end
            task.wait(0.05)
        end
    ...
    local axolotlID = plantAndTrack("unit_axolotl_cave", getAxolotlPlacement, "Axolotl Hideout", 2)
    ...
    print("[VOLCANO] ✓ Axolotl Hideout sold")
    ...
    if glowthorn2ID then
        ...
        print("[VOLCANO] ✓ Glowthorn 2 sold")
        task.wait(0.05 + math.random() * 0.10)
    end
