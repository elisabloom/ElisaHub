...
local function getCurrentMap()
    local success, result = pcall(function()
        ...
        local lobbySetMap = remoteFunctions:FindFirstChild("LobbySetMap_28")
        local lobbySetMaxPlayers = remoteFunctions:FindFirstChild("LobbySetMaxPlayers_28")
        ...
        Callback = function(state)
            if state then
                ...
                local success, err = pcall(function()
                    ...
                    local success2 = game:GetService("ReplicatedStorage"):WaitForChild("RemoteFunctions"):WaitForChild("LobbySetMap_28"):InvokeServer(unpack(args))
...
local remoteCollect = game:GetService("ReplicatedStorage").RemoteEvents.CollectCollectable
local remoteAA = game:GetService("ReplicatedStorage").RemoteFunctions.AAItemDropCollect
