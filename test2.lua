...
local function runVolcanoV1()
    ...
    local function plantTreasureTrapRandom(maxAttempts)
        ...
        local minX = 154.19876098632812
        local maxX = 158.602294921875
        local minZ = -48.12631607055664
        local maxZ = -41.10620880126953
        local fixedY = -31.318031311035156

        -- Orientación interpolada entre las dos rotaciones originales
        ...
        for attempt = 1, maxAttempts do
            ...
            local placementData = {
                Valid = true,
                PathIndex = 1,
                Position = Vector3.new(randomX, fixedY, randomZ),
                CF = CFrame.new(randomX, fixedY, randomZ) * CFrame.new(rot.XVector, rot.YVector, rot.ZVector),
                Rotation = 180
            }
