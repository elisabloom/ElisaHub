        ...
        pcall(function()
            ...
            for _, gui in ipairs(PlayerGui:GetChildren()) do
                for _, button in ipairs(gui:GetDescendants()) do
                    if button:IsA("TextButton") and string.lower(button.Text):find("again") then
                        local path = button.Name
                        local current = button.Parent
                        while current and current ~= gui do
                            path = current.Name .. " > " .. path
                            current = current.Parent
                        end
                        print("[DEBUG BUTTON] GUI: " .. gui.Name .. " | Path: " .. path .. " | Visible: " .. tostring(button.Visible) .. " | Text: " .. button.Text)
                    end
                end
            end
        end)
            ...
            for _, button in ipairs(gui:GetDescendants()) do
                if button:IsA("TextButton") and button.Visible then
                    ...
                    if string.find(text, "again") or string.find(text, "play") then
                        print("[PLAY AGAIN] Button found: '" .. button.Text .. "' - Clicking...")
