...
local function getCurrentMap()
    local success, result = pcall(function()
        ...
        local lobbySetMap = remoteFunctions:FindFirstChild("LobbySetMap_18")
        local lobbySetMaxPlayers = remoteFunctions:FindFirstChild("LobbySetMaxPlayers_18")
        ...
        Callback = function(state)
            if state then
                ...
                local success, err = pcall(function()
                    ...
                    local success2 = game:GetService("ReplicatedStorage"):WaitForChild("RemoteFunctions"):WaitForChild("LobbySetMap_18"):InvokeServer(unpack(args))
                ...
                if currentMap == "map_lobby" then
                    ...
                    task.spawn(function()
                        ...
                        if Character then
                            local HumanoidRootPart = Character:FindFirstChild("HumanoidRootPart")
                            if HumanoidRootPart then
                                print("[GRAVEYARD V1] Teleporting to lobby position...")
                                HumanoidRootPart.CFrame = CFrame.new(118.89, 78, 779.65)
                                task.wait(1)
                                print("[GRAVEYARD V1] ✓ Teleported successfully")
                            end
                        end
                        
                        print("[GRAVEYARD V1] Setting max players to 1...")
                        local success1 = pcall(function()
                            local args = { 1 }
                            game:GetService("ReplicatedStorage"):WaitForChild("RemoteFunctions"):WaitForChild("LobbySetMaxPlayers_18"):InvokeServer(unpack(args))
                        end)
                        print("[GRAVEYARD V1] SetMaxPlayers result: " .. tostring(success1))
                        task.wait(0.3)
                        
                        print("[GRAVEYARD V1] Setting map to Graveyard...")
                        local success2 = pcall(function()
                            local args = { "map_graveyard" }
                            game:GetService("ReplicatedStorage"):WaitForChild("RemoteFunctions"):WaitForChild("LobbySetMap_18"):InvokeServer(unpack(args))
                        end)
                        print("[GRAVEYARD V1] SetMap result: " .. tostring(success2))
            ...
            if state then
                ...
                if currentMap == "map_lobby" then
                    ...
                    task.spawn(function()
                        ...
                        local success1 = pcall(function()
                            game:GetService("ReplicatedStorage"):WaitForChild("RemoteFunctions"):WaitForChild("LobbySetMaxPlayers_18"):InvokeServer(1)
                        end)
                        ...
                        local success2 = pcall(function()
                            game:GetService("ReplicatedStorage"):WaitForChild("RemoteFunctions"):WaitForChild("LobbySetMap_18"):InvokeServer("map_graveyard")
                        end)
