...
if not glow2Planted then
    ...
    while not wave20Detected and getgenv().AutoFarmConfig.VolcanoActive do
...
local function runVolcanoV2()
    ...
    -- ===== COORDENADAS BASE =====
    -- Treasure Trap: entre las dos posiciones dadas
    local treasurePos1 = {x = 161.70401000976562, y = -31.31800079345703, z = -34.11392593383789, dist = 90.62213111349034}
    local treasurePos2 = {x = 163.7417755126953,  y = -31.318737030029297, z = -27.542736053466797, dist = 97.50919463759463}

    -- Rafflesia: mismas del v1
    ...
    -- Chicken Coop: entre las dos posiciones dadas
    ...
    local chickenID = plantWithRetryRandom("unit_chicken_coop", getRandomChickenPosition, "Chicken Coop", 3)
    ...
    while not wave20Detected and getgenv().AutoFarmConfig.VolcanoV2Active do
        if isGameEnded() then return true end
        pcall(function()
            local gui = PlayerGui:FindFirstChild("GameGuiNoInset") or PlayerGui:FindFirstChild("GameGui")
            if gui then
    ...
    print("[VOLCANO V2] ========== SELL COMPLETE ==========")
    return true
end
