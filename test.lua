...
getgenv().eggCollectorRunning = getgenv().eggCollectorRunning or false
local eggCollectorRunning = getgenv().eggCollectorRunning
...
getgenv().EggCollectorToggle = EggCollectorToggle
...
-- ==================== FUNCIONES HELPER ====================
    ...
    local function saveCompleteConfig(configName)
        ...
        local configData = {
            ...
            Misc_EggCollectorEnabled = eggCollectorRunning
        }
    ...
    local function loadCompleteConfig(configName)
        ...
        getgenv().WebhookConfig.URL = configData.Webhook_URL or ""
        eggCollectorRunning = configData.Misc_EggCollectorEnabled or false
        getgenv().eggCollectorRunning = eggCollectorRunning
        if getgenv().EggCollectorToggle then
            getgenv().EggCollectorToggle:Set(eggCollectorRunning)
        end
