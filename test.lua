...
local function getCurrentMap()
    local success, result = pcall(function()
        ...
        local lobbySetMap17 = remoteFunctions:FindFirstChild("LobbySetMap_8")
        local lobbySetMaxPlayers17 = remoteFunctions:FindFirstChild("LobbySetMaxPlayers_8")
        local lobbySetMap8 = remoteFunctions:FindFirstChild("LobbySetMap_37")
        local lobbySetMaxPlayers8 = remoteFunctions:FindFirstChild("LobbySetMaxPlayers_37")
