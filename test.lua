...
local function runVolcanoV2()
    ...
    local function getRandomTreasurePosition()
        local rx = (math.random() - 0.5) * 2 * (offset + math.random() * 0.3)
        local rz = (math.random() - 0.5) * 2 * (offset + math.random() * 0.3)
    ...
    local function getWindmillPosition()
        ...
        local rx = (math.random() - 0.5) * 2 * (offset + math.random() * 1.5)
        local rz = (math.random() - 0.5) * 2 * (offset + math.random() * 1.5)
