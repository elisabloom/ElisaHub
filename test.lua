...
local function runVolcano()
    ...
    local axolotlID = plantAndTrack("unit_axolotl_cave", getAxolotlPlacement, "Axolotl Hideout", 3)
    ...
    local windmillID = plantAndTrack("unit_windmill", getWindmillPlacement, "Windmill", 3)
