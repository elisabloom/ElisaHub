...
local function runVolcano()
    ...
    -- ===== PASO 3: Glowthorn → Lvl 5 =====
    print("[VOLCANO] ========== PASO 3: GLOWTHORN → LVL 5 ==========")
...
local VolcanoToggle = AutoFarmTab:Toggle({
    Flag = "Volcano",
    Title = "Volcano",
    Desc = "Glowthorn + Rafflesia | dif_hell | Wave 20 sell",
