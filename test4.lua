...
local function loadWebhookConfig()
    ...
    -- ✅ RETORNAR SOLO URL, FORZAR GamesPlayed = 0
    return {
        URL = data.URL or "",
        GamesPlayed = 0,  -- ✅ SIEMPRE 0 EN CADA EJECUCIÓN
        IsTracking = false
    }
end
    end
    
    -- ✅ SIEMPRE RETORNAR GamesPlayed = 0 (resetear en cada ejecución)
    return {
        URL = "",
        GamesPlayed = 0,  -- ✅ SIEMPRE INICIA EN 0
        IsTracking = false
    }
end
...
local function saveWebhookConfig()
    ...
    pcall(function()
        ...
        print("[WEBHOOK] Config saved (URL only)")
    end)
end
